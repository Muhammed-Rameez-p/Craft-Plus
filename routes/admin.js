...
const {
  getAdminLogin, adminPost, getAddCategory, getAdminUsers, blockUser, unblockUser, getCategory,
  addCategory, getEditCategory, editCategory, getAdminProducts, getAddProductPage, editProduct, uploadProduct,
